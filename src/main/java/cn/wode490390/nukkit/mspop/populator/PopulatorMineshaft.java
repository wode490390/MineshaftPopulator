package cn.wode490390.nukkit.mspop.populator;
...
import cn.wode490390.nukkit.mspop.MineshaftPlugin;
import cn.wode490390.nukkit.mspop.math.BoundingBox;
import cn.wode490390.nukkit.mspop.scheduler.CallbackableChunkGenerationTask;
import cn.wode490390.nukkit.mspop.structure.MineshaftPieces;
import cn.wode490390.nukkit.mspop.structure.StructurePiece;
import cn.wode490390.nukkit.mspop.structure.StructureStart;
        ...
        if (VALID_BIOMES[chunk.getBiomeId(7, 7)]) {
            ...
            if (random.nextBoundedInt(1000) < PROBABILITY) {
                ...
                if (start.isValid()) { //TODO: serialize nbt
                    ...
                    MineshaftPlugin.debug(this.getClass().getSimpleName(), chunkX << 4, chunkZ << 4);
                }
            }
        }
    }
